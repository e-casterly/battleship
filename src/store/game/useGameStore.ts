...
import type { FleetHealth, Shots, Phase, PlayerId, ShipCells, ShipsLayout } from "@app-types/game.types.ts";
...
const getEmptyGameplayState = () => ({
  ...
  fleetHealth: setDataForPlayers(PLAYERS_IDS, () => ({}) as FleetHealth[string]),
